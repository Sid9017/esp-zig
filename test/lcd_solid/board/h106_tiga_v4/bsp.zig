//! H106-S3-TIGA-V4 display pins and resolution (matches `x/c/esp/h106/bsp/H106_TIGA_V4_board`).
//! C implementation: `st7789_helper/lcd_st7789.c`.
...
pub const lcd = struct {
    ...
    pub const gpio = struct {
        ...
        /// MISO pin reused as D/C (same as H106 `board.c`: `dc_gpio_num = BSP_GPIO_SPI_MISO`).
        pub const dc: i32 = 39;
        pub const cs: i32 = 40;
