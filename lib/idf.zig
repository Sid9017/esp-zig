pub const sdkconfig = @import("idf/sdk_config/sdkconfig.zig");
...
pub const idf_cmd = @import("idf/idf_cmd.zig");
...
test "idf/unit_tests" {
    ...
    _ = @import("idf/sdk_config/sdkconfig.zig");
